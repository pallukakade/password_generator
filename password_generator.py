...
Description:
   ...
   as well as numbers and of length 12 characters. A strong password to provides great security.
...
def password_check(passwd):
    val = True
    if len(passwd) == 12:
        print('Valid Password length :  Generated Password  is of 12 characters ')
        val = True

    if len(passwd) > 12:
        print('Invalid Password length :  Password length is greater than 12 characters')
        val = False

    if len(passwd) < 12:
        print('Invalid Password length :  Password length is less than 12 characters ')
        val = False
